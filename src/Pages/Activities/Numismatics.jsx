...
//   return (
//     <div className="min-h-screen text-gray-100 px-6 py-24 space-y-20 relative ">
...
//             // className="w-full h-40 sm:h-48 md:h-60 lg:h-72 xl:h-80 object-cover"
//           className="w-full h-64 sm:h-80 md:h-96 lg:h-[28rem] xl:h-[32rem] object-cover"
//           />
//           <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-12 space-y-4 sm:space-y-6">
...
//             </h1>
//             <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 font-bold max-w-3xl">
...
//             <Link
//               to="/hobby"
//               className="inline-block bg-gradient-to-r from-indigo-600 to-blue-500 hover:from-blue-500 hover:to-indigo-600 text-white font-semibold py-2 sm:py-3 px-5 sm:px-7 rounded-lg transition transform hover:scale-105"
//             >
//               Back to Hobby
//             </Link>
//           </div>
...
//         <p className="text-center text-gray-300 mb-6">My collection features coins from the Bengal Sultanate, Tripura, Assam, Cooch Behar, and the Gupta dynasty, as well as unique coins inscribed with Bengali scripts. Each piece represents a rich historical and cultural heritage, reflecting the artistry and economy of its era.</p>
...
//         <p className="text-center text-gray-300 mb-6">I collect British India banknotes, Bangladesh old issues, and rare notes from countries that no longer exist. These banknotes not only hold monetary value but also provide a glimpse into the history, politics, and design styles of different regions across time.</p>
//         <Marquee images={banknotes} width="w-[20rem] md:w-[28rem]" height="h-64 md:h-80" />
//       </section>

//       {/* Awards */}
//       <section>
//         {/* <h1 className="text-4xl md:text-6xl font-bold text-center mb-2 text-indigo-300">Awards & Appreciations</h1>
//         <p className="text-center text-gray-300 mb-6">Over the years, my passion for numismatics has been recognized through several awards and appreciations. These honors celebrate my dedication, meticulous collecting, and contributions to preserving historical currency.</p> */}
...
//         <p className="text-center text-gray-300 mb-6">I have participated in numerous numismatic exhibitions, showcasing my collection to fellow enthusiasts and the general public. These events provide a platform to share knowledge, inspire curiosity, and connect with collectors who share the same passion for history and currency.</p>
//         <Marquee images={exhibitions} width="w-[20rem] md:w-[28rem]" height="h-64 md:h-80" />
//       </section>

//       {/* Button- Back to Hobby */}
