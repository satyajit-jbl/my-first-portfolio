  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row text-gray-300 py-20">
      ...
      <aside className="lg:w-1/4 w-full p-6 border-b lg:border-b-0 lg:border-r border-gray-200 flex flex-col gap-6">
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold mb-2 text-yellow-400">Numismatics</h2>
        <p className="text-sm md:text-base text-gray-300 leading-relaxed">
          Explore coins, banknotes, awards, and exhibitions — a journey through history captured in currency and recognition.
        </p>

        {/* <h3 className="text-lg font-medium mb-2 font-bold">Categories</h3> */}
        <ul className="space-y-2 text-sm md:text-base">
          {/* <li><Link to="/numismatics" className="hover:text-yellow-300">📜 All</Link></li> */}
          <li><Link to="/numismatics/coins" className="hover:text-yellow-300">💰 Coins</Link></li>
          <li><Link to="/numismatics/banknotes" className="hover:text-green-300">💵 Banknotes</Link></li>
          <li><Link to="/numismatics/exhibitions" className="hover:text-purple-300">🎪 Exhibitions</Link></li>
          <li><Link to="/numismatics/awards" className="hover:text-indigo-300">🏆 Awards & Appreciations</Link></li>
        </ul>
