  ...
  return (
    <div id="about" className="px-6 md:px-16 flex flex-col md:flex-row items-center w-full justify-center py-5">
      ...
      >
        ...
        Hi there! I'm a MERN stack developer with a background in Mathematics & an MBA in Finance. My journey into web development was driven by a deep curiosity for crafting interactive and user-friendly digital experiences. Over time, I’ve honed my expertise in React, Node.js, Express, and MongoDB, enabling me to build scalable applications with seamless performance.
        </p>
        <p className="text-sm md:text-base text-gray-400 max-w-2xl">
